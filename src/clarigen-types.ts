...
export const contracts = {
  ...
  pox4: {
    functions: {
      ...
      setBurnchainParameters: {
        ...
        Response<boolean, bigint>
      >,
      setSignerKeyAllowance: {
        name: 'set-signer-key-allowance',
        access: 'public',
        args: [
          {
            name: 'pox-addr',
  ...
  signersVoting: {
    ...
    constants: {
      ...
      poxInfo: {
        firstBurnchainBlockHeight: 0n,
        minAmountUstx: 125000000000n,
        prepareCycleLength: 50n,
        rewardCycleId: 0n,
        rewardCycleLength: 1050n,
        totalLiquidSupplyUstx: 1000000000000000n,
      },
      thresholdConsensus: 700n,
    },
    // constants: {},
    non_fungible_tokens: [],
    fungible_tokens: [],
